...
You can start by creating a conda environment with the correct version of Python. We've called it cathyEnv below, but you can name it as you wish:
`conda env create -n cathyEnv python=3.6`
...
Use "git clone" to get each of the above projects in their own directory.  Then, in each project directory, use "pip" to install it into the current environment:
`pip install -e .`
